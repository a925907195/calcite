...
* Append meta data/statistics: some statistics like “table index for scan”, “skew info of some shuffle keys”,
...
i.e. min parallelism / memory (resource consuming UDF) / special resource requirement (GPU / SSD disk) ...
